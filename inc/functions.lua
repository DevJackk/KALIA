...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(kalia..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 1681170979 then
var =  'مطوره السورس'
elseif  UserID == 1646796547 then
var =  'المبرمج جاك'
elseif redis:sismember(kalia..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(kalia..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(kalia..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(kalia..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(kalia..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(kalia..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(kalia..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(kalia..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(kalia..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(kalia..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(kalia..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(kalia..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(kalia..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(kalia..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(kalia..':SUDO_BOT:')
message = '⚈ ** قائمه الـمـطـوريـن : \n\n`⚈ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(kalia..'username:'..v)
local count = redis:scard(kalia..'mtwr_count'..v)
...
local monsha = redis:smembers(kalia..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⚈ قائمه المدراء :*\n\n'
local list = redis:smembers(kalia..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(kalia..'admins:'..msg.chat_id_)
...
local list = redis:smembers(kalia..'whitelist:'..msg.chat_id_)
...
if redis:sismember(kalia..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kalia..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(kalia..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(kalia..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kalia..'gban_users')
...
local list = redis:smembers(kalia..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(kalia..':Filter_Word:'..msg.chat_id_,word) then 
return  "⚈ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(kalia..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(kalia..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(kalia..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(kalia..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(kalia..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(kalia..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(kalia..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(kalia..'group:ids')
message = '⚈ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(kalia..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px kalia;}</style>
<body>
...
redis:del(
kalia..'group:add'..id_group,
kalia..'lock_link'..id_group, 
kalia..'lock_id'..id_group,
kalia..'lock_spam'..id_group, 
kalia..'lock_webpage'..id_group,
kalia..'lock_markdown'..id_group,
kalia..'lock_flood'..id_group,
kalia..'lock_bots'..id_group,
kalia..'mute_forward'..id_group,
kalia..'mute_contact'..id_group,
kalia..'mute_location'..id_group,
kalia..'mute_document'..id_group,
kalia..'mute_keyboard'..id_group,
kalia..'mute_game'..id_group,
kalia..'mute_inline'..id_group,
kalia..'lock_username'..id_group,
kalia..'num_msg_kalia'..id_group,
kalia..'replay'..id_group
)
redis:srem(kalia..'group:ids',id_group)
end
...
redis:hset(kalia..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(kalia..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(kalia..'group:add'..msg.chat_id_) then  return '⚈ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(kalia..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(kalia..':addnumberusers') or 0)
...
local lock_service = redis:get(kalia..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(kalia..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(kalia..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
kalia..'group:add'..msg.chat_id_,true,
kalia..'lock_link'..msg.chat_id_,true, 
kalia..'lock_id'..msg.chat_id_,true,
kalia..'lock_spam'..msg.chat_id_,true,
kalia..'lock_webpage'..msg.chat_id_,true,
kalia..'lock_markdown'..msg.chat_id_,true,
kalia..'lock_flood'..msg.chat_id_,true,
kalia..'lock_bots'..msg.chat_id_,true,
kalia..'mute_forward'..msg.chat_id_,true,
kalia..'mute_contact'..msg.chat_id_,true,
kalia..'mute_location'..msg.chat_id_,true,
kalia..'mute_document'..msg.chat_id_,true,
kalia..'mute_keyboard'..msg.chat_id_,true,
kalia..'mute_game'..msg.chat_id_,true,
kalia..'mute_inline'..msg.chat_id_,true,
kalia..'lock_username'..msg.chat_id_,true,
kalia..'num_msg_kalia'..msg.chat_id_,5, 
kalia..'replay'..msg.chat_id_,true
)

redis:sadd(kalia..'group:ids',msg.chat_id_) 
redis:sadd(kalia..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(kalia..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(kalia..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(kalia..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(kalia..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID,'username',Resolv)
redis:sadd(kalia..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(kalia..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(kalia..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kalia..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID,'username',Resolv)
redis:sadd(kalia..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(kalia..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(kalia..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(kalia..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(kalia..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(kalia..'whitelist:'..ChatID,UserID)
...
if redis:sismember(kalia..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..'owners:'..ChatID,UserID)
...
if redis:sismember(kalia..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(kalia..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(kalia..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(kalia..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(kalia..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(kalia..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك حظر مطوره السورس\n") 
elseif UserID == 1646796547 then 
...
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(kalia..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(kalia..'banned:'..ChatID,UserID)
...
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك كتم مطوره السورس\n") 
elseif UserID == 1646796547 then 
...
if redis:sismember(kalia..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(kalia..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(kalia..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(kalia..'username:'..UserID, 'username',Resolv)
redis:sadd(kalia..'gban_users',UserID)
...
redis:srem(kalia..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد مطوره السورس\n") 
elseif UserID == 1646796547 then 
...
if redis:sismember(kalia..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(kalia..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(kalia..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك تقييد مطوره السورس\n") 
elseif UserID == 1646796547 then 
...
redis:hset(kalia..'username:'..UserID, 'username', UserName)
redis:sadd(kalia..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kalia..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⚈ **العضو » ❪ '..UserName..' ❫\n⚈ **الايدي » ❪ `'..UserID..'` ❫\n⚈ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد مطوره السورسn") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المبرمج جاك\n")
elseif redis:sismember(kalia..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(kalia..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(kalia..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(kalia..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(kalia..'username:'..UserID, 'username', Resolv)
redis:sadd(kalia..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(kalia..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(kalia..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⚈ **العضو » '..USERNAME..' \n⚈ ** الايدي » (`'..UserID..'`)\n⚈ **انه بالتأكيد ليس مطور \n') end
redis:srem(kalia..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⚈ العضو » ❪ '..USERNAME..' ❫\n⚈ الايدي » ❪ '..UserID..' ❫\n⚈ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1681170979 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك مطوره السورس\n")  
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المبرمج جاك\n") 
elseif redis:sismember(kalia..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚈ **لا يمكنك طرد المطور\n") 
...
if redis:get(kalia..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(kalia..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(kalia..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(kalia..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⚈*` اعدادات المجموعه :` \n"
.."\n⚈ التعديل «» "..(redis:get(kalia..'lock_edit'..msg.chat_id_) or 'false')
.."\n⚈ الروابط «» "..(redis:get(kalia..'lock_link'..msg.chat_id_) or 'false')
.."\n⚈ التاك «» "..(redis:get(kalia..'lock_tag'..msg.chat_id_) or 'false')
.."\n⚈ المعرفات «» "..(redis:get(kalia..'lock_username'..msg.chat_id_) or 'false')
.."\n⚈ التكرار «» "..(redis:get(kalia..'lock_flood'..msg.chat_id_) or 'false')
.."\n⚈ الكلايش «» "..(redis:get(kalia..'lock_spam'..msg.chat_id_) or 'false')
.."\n⚈ الويب «» "..(redis:get(kalia..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚈ الماركدوان «» "..(redis:get(kalia..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⚈ بالطرد البوتات «» "..(redis:get(kalia..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⚈ البوتات «» "..(redis:get(kalia..'lock_bots'..msg.chat_id_) or 'false')
.."\n⚈ عدد التكرار «» "..(redis:get(kalia..'num_msg_kalia'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚈`اعدادات الوسائط :`\n"
.."\n*⚈ *المتحركه «» "..(redis:get(kalia..'mute_gif'..msg.chat_id_) or 'false')
.."\n⚈ الدردشه «» "..(redis:get(kalia..'mute_text'..msg.chat_id_) or 'false')
.."\n⚈ الانلاين «» "..(redis:get(kalia..'mute_inline'..msg.chat_id_) or 'false')
.."\n⚈ الالعاب «» "..(redis:get(kalia..'mute_game'..msg.chat_id_) or 'false')
.."\n⚈ الصور «» "..(redis:get(kalia..'mute_photo'..msg.chat_id_) or 'false')
.."\n⚈ الفيديو «» "..(redis:get(kalia..'mute_video'..msg.chat_id_) or 'false')
.."\n⚈ البصمات «» "..(redis:get(kalia..'mute_audio'..msg.chat_id_) or 'false')
.."\n⚈ الصوت «» "..(redis:get(kalia..'mute_voice'..msg.chat_id_) or 'false')
.."\n⚈ الملصقات «» "..(redis:get(kalia..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⚈ الجهات «» "..(redis:get(kalia..'mute_contact'..msg.chat_id_) or 'false')
.."\n⚈ التوجيه «» "..(redis:get(kalia..'mute_forward'..msg.chat_id_) or 'false')
.."\n⚈ الموقع «» "..(redis:get(kalia..'mute_location'..msg.chat_id_) or 'false')
.."\n⚈ الملفات «» "..(redis:get(kalia..'mute_document'..msg.chat_id_) or 'false')
.."\n⚈ الاشعارات «» "..(redis:get(kalia..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⚈ الكيبورد «» "..(redis:get(kalia..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚈*`اعدادات اخرى : `"
.."\n\n*⚈*الترحيب «» "..welcomex
.."\n*⚈*الردود «» "..replayx
...
.."\n*⚈*الويب «» "..(redis:get(kalia..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚈*الماركدوان «» "..(redis:get(kalia..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⚈*البوتات بالطرد «» "..(redis:get(kalia..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⚈*البوتات «» "..(redis:get(kalia..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⚈*عدد التكرار «» "..(redis:get(kalia..'num_msg_kalia'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚈*اعدادات التقـييد :\n"
.."\n*⚈*التقييد بالتوجيه «» "..(redis:get(kalia..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⚈*التقييد بالصور «» "..(redis:get(kalia..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⚈*التقييد بالروابط «» "..(redis:get(kalia..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⚈*التقييد بالمتحركه «» "..(redis:get(kalia..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⚈*التقييد الفيديو «» "..(redis:get(kalia..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
