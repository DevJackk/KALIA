...
redis:set(kalia.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(kalia..'lock:join:'..msg.chat_id_,true)
...
redis:del(kalia..'lock:join:'..msg.chat_id_)
return "*⚈ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n⚈ ** تم فتح الدخول بالرابط \n*" 
end


local function ikalia(msg,MsgText)

Channel = redis:get(kalia..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(kalia..'joinchnl') then
...
redis:setex(kalia..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(kalia..'CheckExpire::'..msg.chat_id_) then 
redis:set(kalia..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(kalia..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(kalia..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(kalia..'CheckExpire::'..msg.chat_id_) then 
redis:set(kalia..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(kalia..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(kalia..'CheckExpire::'..msg.chat_id_) then 
redis:set(kalia..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(kalia..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(kalia..'CheckExpire::'..msg.chat_id_) then 
redis:set(kalia..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(kalia..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(kalia..'group:name'..msg.chat_id_) or '')
redis:set(kalia..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(kalia..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. kalia..'')
...
if not msg.Director and redis:get(kalia..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(kalia..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(kalia..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(kalia..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(kalia..'admins:'..msg.chat_id_)
redis:del(kalia..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(kalia..'owners:'..msg.chat_id_)
redis:del(kalia..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(kalia..'whitelist:'..msg.chat_id_)
redis:del(kalia..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(kalia..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(kalia..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(kalia..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(kalia..'linkGroup'..msg.sender_user_id_,300,true)
return '⚈ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(kalia..'linkGroup'..msg.chat_id_) then 
return "⚈ ** اوه لا يوجد رابط .\n⚈ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(kalia..'group:name'..msg.chat_id_)
local GroupLink = redis:get(kalia..'linkGroup'..msg.chat_id_)
...
local Text = "⚈ رابـط الـمـجـمـوعه ⚈ \n"..Flter_Markdown(redis:get(kalia..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(kalia..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(kalia..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "⚈ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(kalia..':Filter_Word:'..msg.chat_id_)
...
redis:del(kalia..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(kalia..'welcome:msg'..msg.chat_id_) then 
return "⚈ ** اوه هنالك خطأ .\n⚈ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(kalia..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(kalia..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⚈ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(kalia..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "⚈ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(kalia..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⚈ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(kalia..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(kalia..'banned:'..msg.chat_id_)
if #list == 0 then return "*⚈ لا يوجد مستخدمين محظورين  *" end
message = '⚈ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(kalia..'banned:'..msg.chat_id_)
return "⚈ **أهلا عزيزي "..msg.TheRankCmd.."   \n⚈  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(kalia..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "⚈ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(kalia..'is_silent_users:'..msg.chat_id_)
...
redis:del(kalia..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "⚈ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(kalia..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(kalia..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "⚈ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(kalia..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(kalia..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(kalia..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(kalia..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(kalia..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(kalia..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(kalia..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(kalia..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(kalia..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(kalia.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(kalia..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(kalia..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(kalia..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(kalia..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(kalia..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(kalia..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(kalia..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(kalia..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(kalia..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "⚈ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '⚈ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚈ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(kalia..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "⚈ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(kalia..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(kalia..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(kalia..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(kalia..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(kalia..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(kalia..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(kalia..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(kalia..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(kalia..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(kalia..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(kalia..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(kalia..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(kalia..'welcome:msg'..msg.chat_id_))
else 
return "⚈ **أهلا عزيزي "..msg.TheRankCmd.."  \n⚈ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(kalia..'group:ids')
...
local pv = redis:smembers(kalia..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(kalia..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(kalia..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚈ اهلا انا بوت]]..redis:get(kalia..':NameBot:')..[[ .
...
redis:setex(kalia..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '⚈ حسننا عزيزي .\n⚈ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(kalia..':addnumberusers',MsgText[2]) 
return '⚈ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'⚈ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(kalia..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "⚈ **هذا الامر يخص {المطور} فقط  \n" end
return '⚈ ** عدد المجموعات المفعلة » `'..redis:scard(kalia..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "⚈ **هذا الامر يخص {المطور} فقط  \n" end
return '⚈ **عدد المشتركين في البوت : `'..redis:scard(kalia..'users')..'` \n'
end
...
if not msg.SudoUser then return "⚈ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(kalia..'group:ids',MsgText[2]) then
local name_gp = redis:get(kalia..'group:name'..MsgText[2])
...
return redis:get(kalia..":TEXT_SUDO") or '⚈ لا توجد كليشه المطور .\n⚈ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"⚈ **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(kalia..'lock_brod') then return "⚈ ** الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(kalia..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "⚈ حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"⚈ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(kalia..'lock_brod') then 
return "⚈ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(kalia..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(kalia..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(kalia..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(kalia..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(kalia..'welcom:witting'..msg.sender_user_id_,
kalia..'rulse:witting'..msg.sender_user_id_,
kalia..'rulse:witting'..msg.sender_user_id_,
kalia..'name:witting'..msg.sender_user_id_,
kalia..'about:witting'..msg.sender_user_id_,
kalia..'fwd:all'..msg.sender_user_id_,
kalia..'fwd:pv'..msg.sender_user_id_,
kalia..'fwd:groups'..msg.sender_user_id_,
kalia..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
kalia..'namebot:witting'..msg.sender_user_id_,
kalia..'addrd_all:'..msg.sender_user_id_,
kalia..'delrd:'..msg.sender_user_id_,
kalia..'addrd:'..msg.sender_user_id_,
kalia..'delrdall:'..msg.sender_user_id_,
kalia..'text_sudo:witting'..msg.sender_user_id_,
kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_,
kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(kalia..":VERSION",GetVerison)
return false
else
...
return '⚈ اصدار سورس كــآلــيـــآ : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'⚈ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كــآلــيـــآ يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '⚈ الاحصائيات . \n\n⚈ **عدد المجموعات المفعله : '..redis:scard(kalia..'group:ids')..'\n⚈ **عدد المشتركين في البوت : '..redis:scard(kalia..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(kalia..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(kalia..'replay:'..msg.chat_id_)
local photo 	= redis:exists(kalia..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(kalia..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(kalia..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(kalia..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(kalia..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(kalia..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(kalia..'replay:'..msg.chat_id_,kalia..'replay_photo:group:'..msg.chat_id_,kalia..'replay_voice:group:'..msg.chat_id_,
kalia..'replay_animation:group:'..msg.chat_id_,kalia..'replay_audio:group:'..msg.chat_id_,kalia..'replay_sticker:group:'..msg.chat_id_,kalia..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(kalia..'replay:all')
local photo 	= redis:exists(kalia..'replay_photo:group:')
local voice 	= redis:exists(kalia..'replay_voice:group:')
local imation 	= redis:exists(kalia..'replay_animation:group:')
local audio 	= redis:exists(kalia..'replay_audio:group:')
local sticker 	= redis:exists(kalia..'replay_sticker:group:')
local video 	= redis:exists(kalia..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(kalia..'replay:all',kalia..'replay_photo:group:',kalia..'replay_voice:group:',kalia..'replay_animation:group:',kalia..'replay_audio:group:',kalia..'replay_sticker:group:',kalia..'replay_video:group:')
...
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(kalia..'delrdall:'..msg.sender_user_id_,true) 
return "⚈ حسننا عزيزي  .\n⚈ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(kalia..'delrd:'..msg.sender_user_id_,true)
return "⚈ حسننا عزيزي  .\n⚈ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "⚈ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(kalia..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(kalia..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(kalia..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(kalia..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(kalia..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(kalia..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(kalia..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(kalia..'replay:all')
local photo 	= redis:hkeys(kalia..'replay_photo:group:')
local voice 	= redis:hkeys(kalia..'replay_voice:group:')
local imation 	= redis:hkeys(kalia..'replay_animation:group:')
local audio 	= redis:hkeys(kalia..'replay_audio:group:')
local sticker 	= redis:hkeys(kalia..'replay_sticker:group:')
local video 	= redis:hkeys(kalia..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '⚈ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "⚈ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(kalia..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "⚈ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(kalia..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n⚈ " end
if not redis:get(kalia..'lave_me'..msg.chat_id_) then 
return "⚈ **أهلا عزيزي "..msg.TheRankCmd.."\n⚈ ** المغادره بالتاكيد تم تفعيلها\n⚈" 
else 
redis:del(kalia..'lave_me'..msg.chat_id_) 
return "⚈ **أهلا عزيزي "..msg.TheRankCmd.."\n⚈ ** تم تفعيل المغادره \n⚈" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "⚈ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n⚈ " end
if redis:get(kalia..'lave_me'..msg.chat_id_) then 
return "⚈ **أهلا عزيزي "..msg.TheRankCmd.."\n⚈ ** المغادره من قبل البوت بالتأكيد معطله\n⚈" 
else
redis:set(kalia..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(kalia..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"⚈ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(kalia..":UserNameChaneel")
if UserChaneel then
...
if redis:get(kalia..'welc'..msg.chat_id_) == 'on' then
...
local hash = kalia..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
function setadmins(kalia,diamond)
...
function remadmins(kalia,diamond)
...
mmd = redis:get(kalia..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(kalia..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(kalia..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'⚈ اهلا عزيزي \n⚈ تم تثبيت الامر الجديد\n⚈')
redis:del(kalia..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "⚈ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(kalia..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(kalia..'CmD:'..msg.chat_id_,cmd)
redis:srem(kalia..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"⚈ اهلا عزيزي\nالامر >"..cmd.."\n⚈ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "⚈ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(kalia..'CmD:'..msg.chat_id_)
redis:del(kalia..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"⚈ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "⚈ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(kalia..'CmDlist:'..msg.chat_id_)
local t = '⚈ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(kalia..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(kalia..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(kalia..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(kalia..'welc'..msg.chat_id_,'off')
redis:del(kalia..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if Black == 'welcome on' or Black == 'تفعيل الكــآلــيـــآ تيم' then
if redis:get(kalia..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الكــآلــيـــآ تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الكــآلــيـــآ تيم')
redis:set(kalia..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم الكــآلــيـــآ' then
if redis:get(kalia..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم الكــآلــيـــآ سابقا')
redis:set(kalia..'welc'..msg.chat_id_,'off')
redis:del(kalia..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الكــآلــيـــآ الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(kalia..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(kalia..'setchs') and msg.SudoUser then
redis:set(kalia..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(kalia..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(kalia..'setchs',120,true)
end
...
function tophoto(kara,kalia)   
if kalia.content_.ID == "MessageSticker" then        
local bd = kalia.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(kalia..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(kalia..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*⚈ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(kalia..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/kalia" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس كــآلــيـــآ\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل الكــآلــيـــآ تيم","تعطيل تيم الكــآلــيـــآ"},
...
redis:sadd(kalia..'users',msg.sender_user_id_)
if redis:get(kalia..'lock_service') then 
text = [[⚈ أهلاً انا بوت   []]..redis:get(kalia..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(kalia.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(kalia..'lock_twasel') then
...
redis:setex(kalia.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(kalia..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(kalia..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(kalia..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n⚈ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(kalia..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه صوره للرد بنجاح\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(kalia..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه بصمه صوت للرد بنجاح\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(kalia..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه متحركه للرد بنجاح\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(kalia..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه فيديو للرد بنجاح\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(kalia..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه للصوت للرد بنجاح\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(kalia..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(kalia..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(kalia..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(kalia..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ⚈ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(kalia..'replay_photo:group:',klma,photo_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه صوره للرد العام\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(kalia..'replay_voice:group:',klma,voice_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه بصمه صوت للرد العام\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(kalia..'replay_animation:group:',klma,animation_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه متحركه للرد العام\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(kalia..'replay_video:group:',klma,video_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه فيديو للرد العام\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(kalia..'replay_audio:group:',klma,audio_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم اضافه للصوت للرد العام\n⚈ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(kalia..'replay_sticker:group:',klma,sticker_id)
redis:del(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(kalia..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(kalia..":ForceSub:"..msg.sender_user_id_)
...
redis:set(kalia..":UserNameChaneel",msg.text)
...
if redis:get(kalia..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(kalia..'namebot:witting'..msg.sender_user_id_)
redis:set(kalia..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"⚈ تم تغير اسم البوت  .\n⚈ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(kalia..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(kalia..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(kalia..'replay_photo:group:',msg.text)
redis:hdel(kalia..'replay_voice:group:',msg.text)
redis:hdel(kalia..'replay_animation:group:',msg.text)
redis:hdel(kalia..'replay_audio:group:',msg.text)
redis:hdel(kalia..'replay_sticker:group:',msg.text)
redis:hdel(kalia..'replay_video:group:',msg.text)
redis:setex(kalia..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⚈ جيد , يمكنك الان ارسال جوا ب الردالعام \n⚈ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(kalia..'delrdall:'..msg.sender_user_id_) then
redis:del(kalia..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(kalia..'replay:all',msg.text)
local photo =redis:hget(kalia..'replay_photo:group:',msg.text)
local voice = redis:hget(kalia..'replay_voice:group:',msg.text)
local animation = redis:hget(kalia..'replay_animation:group:',msg.text)
local audio = redis:hget(kalia..'replay_audio:group:',msg.text)
local sticker = redis:hget(kalia..'replay_sticker:group:',msg.text)
local video = redis:hget(kalia..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⚈ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(kalia..'replay:all',msg.text)
redis:hdel(kalia..'replay_photo:group:',msg.text)
redis:hdel(kalia..'replay_voice:group:',msg.text)
redis:hdel(kalia..'replay_audio:group:',msg.text)
redis:hdel(kalia..'replay_animation:group:',msg.text)
...
if redis:get(kalia..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(kalia..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(kalia..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "⚈ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(kalia..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(kalia..'welcom:witting'..msg.sender_user_id_) 
redis:set(kalia..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⚈ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(kalia..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(kalia..'rulse:witting'..msg.sender_user_id_) 
redis:set(kalia..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⚈ ** مرحبآ عزيزي\n⚈ تم حفظ القوانين بنجاح .\n⚈ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(kalia..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(kalia..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(kalia..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(kalia..'linkGroup'..msg.sender_user_id_,link) 
redis:set(kalia..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(kalia..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(kalia..'about:witting'..msg.sender_user_id_) 
...
if redis:get(kalia..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(kalia..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(kalia..'users')  
local groups = redis:smembers(kalia..'group:ids')
...
if redis:get(kalia..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(kalia..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(kalia..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(kalia..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'⚈ **عدد المجموعات { *'..#groups..'*  } ⊰•\n⚈ **تـم الاذاعه بالتثبيت بنجاح ♥')
end

if redis:get(kalia..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(kalia..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(kalia..'users')
if #pv >= 300 then
...
if redis:get(kalia..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(kalia..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(kalia..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'⚈ اهلا عزيزي المطور \n⚈ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.adduser and msg.adduser == our_id and redis:get(kalia..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(kalia..':WELCOME_BOT'),[[⚈أهلاً انا بوت ]]..redis:get(kalia..':NameBot:')..[[
⚈ أختصاصي حماية‌‏ المجموعات
⚈ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(kalia..'fwd:'..msg.sender_user_id_) then
redis:del(kalia..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(kalia..'users')
local groups = redis:smembers(kalia..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(kalia..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(kalia..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(kalia..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'⚈ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(kalia..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(kalia..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(kalia..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(kalia..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(kalia..'replay:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(kalia..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(kalia..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⚈ جيد , يمكنك الان ارسال جواب الرد \n⚈ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(kalia..'delrd:'..msg.sender_user_id_) then
redis:del(kalia..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(kalia..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(kalia..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(kalia..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(kalia..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(kalia..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(kalia..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(kalia..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⚈ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(kalia..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(kalia..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(kalia..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(kalia..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(kalia..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(kalia..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(kalia..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(kalia..'welcome:msg'..msg.chat_id_) or "⚈ اهلاً عزيزي {الاسم}\n⚈ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚈ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(kalia..'rulse:msg'..msg.chat_id_) or "⚈ مرحباً عزيري القوانين كلاتي .\n⚈ ممنوع نشر الروابط\n⚈ ممنوع التكلم او نشر صور اباحيه\n⚈ ممنوع  اعاده توجيه\n⚈ ممنوع التكلم بالسياسة\n⚈ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(kalia..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(kalia..'welcome:msg'..msg.chat_id_) or "⚈ اهلن بك عزيزي {الاسم}\n⚈ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚈ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(kalia..'rulse:msg'..msg.chat_id_) or "⚈ مرحباً عزيري القوانين كلاتي .\n⚈ ممنوع نشر الروابط\n⚈ ممنوع التكلم او نشر صور اباحيه\n⚈ ممنوع  اعاده توجيه\n⚈ ممنوع التكلم بالسياسة\n⚈ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(kalia..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(kalia..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(kalia..'welcome:get'..msg.chat_id_)
end
redis:setex(kalia..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(kalia..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(kalia..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_kalia = (redis:get(kalia..'num_msg_kalia'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_kalia) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(kalia..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"⚈ العضو » "..USERNAME.."\n⚈ قمـت بتكرار اكثر مـن "..NUM_MSG_kalia.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(kalia..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(kalia..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(kalia..'lock_woring'..msg.chat_id_) and not redis:get(kalia..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(kalia..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(kalia..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(kalia..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'⚈ ** لا يمكنني مسح الرساله المخالفه .\n⚈ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(kalia..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(kalia..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kalia..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kalia..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(kalia..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(kalia..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(kalia..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(kalia..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(kalia..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(kalia..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(kalia..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(kalia..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kalia..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(kalia..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kalia..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(kalia..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(kalia..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(kalia..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kalia..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(kalia..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(kalia..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(kalia..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(kalia..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(kalia..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(kalia..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kalia..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(kalia..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(kalia..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(kalia..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(kalia..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(kalia..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(kalia..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(kalia..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(kalia..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kalia..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "رفع الكــآلــيـــآ"  then return sendMsg(msg.chat_id_,msg.id_,"⚈ آههلآ  عـزيزي\n⚈ لقد تم رفع كــآلــيـــآ بنجاح \n⚈ اديلو كــآلــيـــآ\n")
elseif Text== "تنزيل الكــآلــيـــآ"  then return sendMsg(msg.chat_id_,msg.id_,"⚈ آههلآ  عـزيزي\n⚈ لقد تم رفع كــآلــيـــآ بنجاح \n⚈ اديلو كــآلــيـــآ\n")
...
elseif Text== "رفع كــآلــيـــآ"  then return sendMsg(msg.chat_id_,msg.id_,"⚈ آههلآ  عـزيزي\n⚈ تم رفع الواد ضمن الزنوج بنجاح\n⚈الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل كــآلــيـــآ"  then return sendMsg(msg.chat_id_,msg.id_,"⚈ آههلآ  عـزيزي\n⚈ تم ازاله الواد بعيدا عن الزنوج بنجاح \n⚈الان تم ازلته من قائمه الزنوج\n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/UU_YEV) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/UU_YEV)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/UU_YEV)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/UU_YEV)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/UU_YEV)")
end  
end 

elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/UU_YEV) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/UU_YEV)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/UU_YEV)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/UU_YEV)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/UU_YEV)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..kalia..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(kalia..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(kalia..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(kalia..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(kalia..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(kalia..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(kalia..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(kalia..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(kalia..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(kalia..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'⚈ انتهى الاشتراك في احد المجموعات .\n⚈ المجموعه : '..FlterName(redis:get(kalia..'group:name'..msg.chat_id_))..'.\n⚈ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'⚈ انتهى الاشتراك البوت.\n⚈ سوف اغادر المجموعه فرصه سعيده .\n⚈ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(kalia..'ExpireDate:'..msg.chat_id_) / 86400)
  ...
  "^(طرد) (%d+)$",
  "^(كتم)$",
  '^(تفعيل الكــآلــيـــآ تيم)$',
  '^(تعطيل تيم الكــآلــيـــآ)$',
  "^(كتم) (@[%a%d_]+)$",
  "^(كتم) (%d+)$",
  "^(الغاء الكتم)$",
  "^(الغاء الكتم) (@[%a%d_]+)$",
